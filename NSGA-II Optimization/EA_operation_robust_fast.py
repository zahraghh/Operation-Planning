...
if use_solar_PV=='yes':
    ...
    A_solar = roof_top_area*PV_module*int(editable_data['solar_index'])
else:
    A_solar = 0
    ...
    for represent in range(num_clusters):
        for day in range(num_scenarios):
            ...
            for hour in range(0,24):
                ...
                problem= Operation_EA(G_T_now,V_wind_now,E_bat[hour], electricity_demand_now,heating_demand_now,electricity_EF)
